...
const ROLES = [
  { value: "PLAYER", label: "个人陪玩", icon: User, gradient: "from-pink-500 to-rose-500", glow: "shadow-pink-500/25", emoji: "🎯", desc: "展示技能，找到老板" },
  { value: "SHOP", label: "陪玩店", icon: Store, gradient: "from-violet-500 to-purple-500", glow: "shadow-purple-500/25", emoji: "🏪", desc: "经营店铺，管理搭子" },
  { value: "BOSS", label: "老板", icon: Crown, gradient: "from-amber-500 to-orange-500", glow: "shadow-amber-500/25", emoji: "👑", desc: "找搭子，轻松上分" },
] as const;
