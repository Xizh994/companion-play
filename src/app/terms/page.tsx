          ...
          <div className="prose prose-invert prose-sm max-w-none text-gray-300 space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm">
                ...
                <li>店铺用户须区分：<strong>企业主体认证</strong>（营业执照对应企业是否真实，以证照及工商信息为准）与<strong>平台负责人</strong>（在本平台负责运营对接的自然人实名，可以与营业执照上的法定代表人/经营者不是同一人）。平台对外联系、纠纷协调以平台负责人及企业主体信息为准；法律责任主体以营业执照登记的企业为准</li>
              </ul>
